...
public class ShareSaveSuccessfulScreen extends Screen {
    ...
    public ShareSaveSuccessfulScreen() {
        ...
        Icon shareImageToDeviceAppsIcon = new Icon(iconCenterX * 1.45, iconCenterY * 1.5, largeIconSize, largeIconSize, loadImage("shareImageToDeviceAppsImage.png"), "\r\n\n" + "Share to other" + "\r\n" + " applications", true, "Below", "_shareImageToDeviceApps");
        Icon returnCameraLiveViewIcon = new Icon(iconCenterX * 0.55, iconCenterY * 1.5, largeIconSize, largeIconSize, loadImage("returnCameraLiveViewIcon.png"), "\r\n\n" + "Return to" + "\r\n" + " camera view", true, "Below", "CameraLiveViewScreen");
